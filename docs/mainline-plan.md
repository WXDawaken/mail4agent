...
- If group-chat-like behavior is ever added, prefer an explicit round/barrier model with required acknowledgements, optional replies, and timeout-based closure rather than open-ended broadcast conversation.
